...
export type BizClientDTO_Input = {
    u_id: string;
    category: string;
...
export type BizClientDTO_Output = {
    u_id: string;
    category: string;
    blob_file_name: string;
    origin_file_name: string;
...
export type GetBizcardDetailResponse = {
    request_id?: string;
    biz_card: BizClientDTO_Output;
    programs: Array<ProgramDTO>;
};

export type GetBizcardsResponse = {
    request_id?: string;
    bizcards: Array<BizClientDTO_Output>;
};
...
export type ProgramStatus = 'interest' | 'requested' | 'negotiation' | 'site_visit' | 'preparation' | 'execution' | 'completed';
...
export type PutBizcardsRequest = {
    u_id: string;
    biz_card: BizClientDTO_Input;
};

export type PutBizcardsResponse = {
    request_id?: string;
    status: boolean;
};
...
export type GetBizcardsApiV1BizGetData = {
    limit?: number;
    offset?: number;
...
export type PutBizcardApiV1BizPutData = {
    requestBody: PutBizcardsRequest;
};

export type PutBizcardApiV1BizPutResponse = (PutBizcardsResponse);

export type GetBizcardDetailApiV1BizDetailGetData = {
    uId: string;
};

export type GetBizcardDetailApiV1BizDetailGetResponse = (GetBizcardDetailResponse);
...
export type StartProgramApiV1ProgramStartGetResponse = (unknown);
